...
class PSCHTree(object):
    ...
    python -u run.py --train --algo MCST --epochs 2 --search_time 4 --max_a_len 3  --beta 100 --batch_size 2 --max_p_len 10000 --hidden_size 150  --train_files ../data/demo/trainset/test10 --dev_files  ../data/demo/devset/test5 --test_files ../data/demo/test/search.test.json
    
    nohup python -u run.py --train --algo MCST --draw_path ./log/30 --gpu 0 --epochs 30 --search_time 3000 --max_a_len 5 --beta 100 --batch_size 20 --max_p_len 10000 --hidden_size 150  --train_files ../data/demo/trainset/search.train.json --dev_files  ../data/demo/devset/search.dev.json --test_files ../data/demo/test/search.test.json ../data/demo/test/search.test.json >beta_100_20_3000_5.txt 2>&1 &
    ...
    def _cal_policys(self, words_list_list, l_passage_list, feeddict):
        ...
        feed_dict = dict(
            {self.selected_id_list: fd_words_list, self.candidate_id: fd_policy_c_id_list,
             self.seq_length: seq_length_list,
    ...
    def _action(self):
        ...
        self.rnn_input = tf.reshape(self.selected_list,
                                    [self.selected_batch_size, -1, self.hidden_size * 2])  # (6,2,300)
    ...
    def _compute_loss(self):
        ...
        self.loss = tf.reduce_mean(
            tf.contrib.losses.mean_squared_error(tf.transpose(self.v), self.value) - tf.reduce_sum(
                tf.multiply(self.policy, tf.reshape(
